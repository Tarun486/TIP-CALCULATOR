   ...
   function  calculateTip() {
    /* assign values of ID : amount, person and service to
       ...
       /* If statement will work when user presses
        ...
        if (persons === '1')
        //if there is only one personthen we need not to display each.
        ...
        document.querySelector('#each').style.display = 'block';
            /* calculating the tip by multiplying total bill and type of
               services, then dividing it by number of persons.*/
               // fixing the total amountupto two digits of decimal
